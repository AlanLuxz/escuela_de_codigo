...
secamos el agua de nuestras manos. ¡Listos! Tenemos nuestras manos limpias.
    ...
    Entrada: Para lavarse las manos
       Declaracion: Buscar, jabon, recipiente con agua, toalla y las manos

    Proceso: Humedecre las manos en el agua, tomar el jabon y frotar, generar espuma, frotar manos, enjuajar hasta quitar toda la espuma, sacar manos del agua u secar con toalla

    Resultado: Obtener manos limpias 
...
1.Realiza las siguientes operaciones numéricas y calcula el valor final:
    ...
    a) (100/5^2 + 1) + 11 * 3 = (100/(5*5)+(1))+11*(3)  (valor 0.5)
                                (100/(25)+(1)+11*(3)
                                (4+(1))+11*(3)
                                (5)+11*(3)
                                (5)+33
    ...
    b) (18/9 + 24) – ( 5 * 4 – 3^3) = ((18/9)+(24))-((5*4)-(27))    (valor 0.5)
                                      ((18/9)+(24))-((20)-(27))
                                      ((2)+(24))-((20)-(27))
                                      (26)-((20)-(27))
                                      (26)-(-7)
    ...
    c) ((8-6)^2 * 3 - 2)^3 = ((2)^2)*3(-(2))^3  (valor 0.5)
                             ((4*3)-2))^3
                             (12-2)^3
                             (10)^3
                             = 1000

    d) (3^2 + 10/2) + (3 * 9 - 1) = ((9)+(10/2))+((27)-1  (valor 0.5)
                                    ((9+(5))+(27-1)
                                    (14)+(27-1)
                                    (14)+26
                                    = 40
